        ...
        {isBibliotecario && (
          <>
            <div className="pt-4 pb-2">
              <p className="px-4 text-xs font-bold tracking-wider text-slate-400 uppercase">Administração</p>
            </div>
            
            <NavLink to="/emprestimos" className={({isActive}) => `flex items-center gap-3 px-4 py-3 rounded-lg font-medium transition-all duration-200 ${isActive ? 'bg-sgb-vinho/10 text-sgb-vinho' : 'text-slate-600 hover:bg-slate-50 hover:text-slate-900'}`}>
